...
### Dashboard
- [Download the file](https://github.com/ajitii/Sales_Data_Analysis-/blob/master/Sales_Report_Ajiti.pbix) and open in Power BI Desktop for interactive viewing.
- [See a screenshot](https://github.com/ajitii/Sales_Data_Analysis-/blob/master/Sales_Report_Ajiti.pdf) of the Dashboard in pdf.
